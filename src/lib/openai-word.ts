...
function buildPrompt(words: string[], targetLang: string): string {
  return `You are a vocabulary assistant. For each English word, provide:
...
- exampleSentence: a simple example sentence in English

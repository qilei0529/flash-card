...
export function TestCardView({
  ...
  return (
    <>
      <div
        className={`flex-1 w-full max-w-[360px] min-h-[280px] mx-auto rounded-3xl border-2 border-gray-200 bg-white p-8 pt-4 pb-4 shadow-2xl shadow-gray-300/40 flex flex-col items-center justify-center ${isRating ? "max-h-[420px] overflow-y-auto" : "max-h-[280px]"
      ...
      >
        ...
        {revealStage === "translation" && (
          <div className="text-center w-full">
            ...
            <p className="py-2 whitespace-pre-wrap text-3xl leading-relaxed">
              {card.data.translation}
            </p>
            {isWordCard(card) && card.data.partOfSpeech && (
              <p className="text-xs text-gray-400 dark:text-gray-500">
